...
contract_choice = int(input("Choose option: "))
...
internet_choice = int(input("Choose option: "))
...
if internet_choice == 1:
    ...
    print("Invalid internet service option.")
    exit()
...
support_choice = int(input("Choose option: "))
...
if support_choice == 1:
    ...
    print("Invalid tech support option.")
    exit()
...
print("\n-------------------------")
print("Total Charges:", round(total_charges, 2))
